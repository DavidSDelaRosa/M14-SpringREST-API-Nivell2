var app = {
    ...
    backend: 'http://localhost:8080/api/tiendas/cuadros',
    table: null,
    ...
    init: function () {
        ...
        $('#save').click(function () {
            ...
            if (isNaN(idCuadro) || idCuadro == '' || idCuadro === '') {
                console.log("Creando")
                app.save({
                    idCuadro, nombreCuadro, autor, precio, fechaCreacion
                })
    ...
    save: function (data) {
        $.ajax({
            ...
            success: function (json) {
                $("#msg").text('Se guardó el cuadro correctamente');
                $("#msg").show();
